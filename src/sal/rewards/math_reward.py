...
from sal.rewards.global_conf import THOUGHT_DELIMITER_START, THOUGHT_DELIMITER_END  # , OAI_RM_MODEL
from sal.rewards import RewardConfig, RewardFn, RewardInput, RewardOutput, RewardType
from sal.rewards.math_utils.utils import extract_answer, grade_answer_sympy, grade_answer_mathd
...
def sal_reward_fn(solution_str: str, ground_truth: Union[str, List[str]], enable_llm = False):
    ...
    Args:
        ...
        enable_llm (bool, optional): whether to use orm if rule-base checking is fail. Defaults to False.
