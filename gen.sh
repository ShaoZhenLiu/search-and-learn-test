...
MODEL_PATH="/data/shaozhen.liu/python_project/hf_models/Qwen2.5-32B-Instruct"
DATA_DIR="/data/shaozhen.liu/python_project/hf_datasets"
DATA_NAME="DeepScaleR-distilled-32b"
DATA_FILE_16K="train-distilled_subset16k.jsonl"
...
python direct_gen.py \
    ...
    --data_names $DATA_NAME \
    --data_file $DATA_FILE_16K \
    --output_dir "${DATA_DIR}/${DATA_NAME}/1k_32b_avg@8_results" \
    --prompt_type qwen25-math \
    --seed 0 \
    --start 0 \
    --end 1000 \
    ...
    --n_sampling 8 \
    --agg_method "avg@n" \
     2>&1 | tee direct_gen_1k_32b_pass@1.log
