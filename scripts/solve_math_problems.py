...
def main():
    ...
    parser.add_argument('--dataset_path', type=str, default='/apdcephfs_sh3/share_302139670/hunyuan/berlinni/liushaozhen/data/DeepScaler-QwQ_32b',
    ...
    parser.add_argument('--question_column', type=str, default='question',
                       help='问题列所在的列名')
    parser.add_argument('--output_dir', type=str, default='/apdcephfs_sh3/share_302139670/hunyuan/berlinni/liushaozhen/data/DeepScaler-QwQ_32b/vllm_results',
                       help='输出目录')
    parser.add_argument('--model', type=str, default='/apdcephfs_sh3/share_302139670/hunyuan/berlinni/liushaozhen/models/Qwen2.5-7B-Instruct',
                       help='使用的模型名称')
